...
from VAT_DataAugmentation_100label_rotate2 import *
import random
import os
...
def train_and_test(model, train_dataloader, VAT_dataloader, val_dataloader, optimizer, threshold, epochs, writer, save_path, device_num, batch_size):
...
class Config:
    def __init__(
        ...
        lr: float = 0.001,
        n_classes: int = 16,
        save_path: str = 'model_weight/CNN_FixMatch_Rotate2_n_classes_16_100label_0unlabel_rand30.pth',
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_FixMatch_Rotate2_100label_rand30")
