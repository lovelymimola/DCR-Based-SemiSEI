...
def TrainDataset(ft, random_num):
    ...
    y = y.astype(np.uint8)
    X_train_labeled, X_train_unlabeled, Y_train_labeled, Y_train_unlabeled = train_test_split(x, y, test_size=0.5, random_state=random_num)

    X_train_label, X_val, Y_train_label, Y_val = train_test_split(X_train_labeled, Y_train_labeled, test_size=0.3, random_state=random_num)
