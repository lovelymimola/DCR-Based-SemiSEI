...
from VAT_DataAugmentation_5label import *
...
class Config:
    def __init__(
        ...
        lr_cent: float = 0.001,
        n_classes: int = 16,
        save_path: str = 'model_weight/CNN_FixMatch_Norm_n_classes_16_5label_95unlabel_rand30.pth',
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_FixMatch_Norm_5label_rand30")
