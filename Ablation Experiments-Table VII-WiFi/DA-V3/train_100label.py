...
class Config:
    def __init__(
        ...
        lr_cent: float = 0.001,
        n_classes: int = 16,
        save_path: str = 'model_weight/CNN_FixMatch_Norm_Rotate2_n_classes_10_100label_0unlabel_rand30.pth',
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_FixMatch_Norm_Rotate2_100label_rand30")
