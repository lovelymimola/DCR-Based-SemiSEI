...
def TrainDataset(ft, random_num):
    ...
    y = y.astype(np.uint8)
    X_train_label, X_val, Y_train_label, Y_val = train_test_split(x, y, test_size=0.3, random_state=random_num)

    return X_train_label, X_train_label, X_val, Y_train_label, Y_train_label, Y_val
